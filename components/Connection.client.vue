...
// import { codeToHtml } from 'shiki'; // You can import this based on the bundler's setup.
...
<template>
  <div class="h-screen flex flex-col justify-between">
    ...
    <div id="messages" class="flex-grow flex flex-col justify-end px-4 py-8">
      <div class="flex items-center mb-4" v-for="message in store.messages" :key="message.date">
